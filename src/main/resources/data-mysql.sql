...
INSERT INTO orders (PRDID, QUANTITY, CONTACT) SELECT B.ID, 1, '0400100101' FROM category A, product B WHERE A.ID=B.CATID AND A.NAME='Monitor' AND B.NAME='Dell' AND NOT EXISTS (SELECT 1 FROM category A, product B, orders C WHERE A.ID=B.CATID AND B.ID=C.PRDID AND A.NAME='Monitor' AND B.NAME='Dell' AND C.CONTACT='0400100101');
INSERT INTO orders (PRDID, QUANTITY, CONTACT) SELECT B.ID, 2, '0400100102' FROM category A, product B WHERE A.ID=B.CATID AND A.NAME='Monitor' AND B.NAME='Apple' AND NOT EXISTS (SELECT 1 FROM category A, product B, orders C WHERE A.ID=B.CATID AND B.ID=C.PRDID AND A.NAME='Monitor' AND B.NAME='Apple' AND C.CONTACT='0400100102');
INSERT INTO orders (PRDID, QUANTITY, CONTACT) SELECT B.ID, 2, '0400100103' FROM category A, product B WHERE A.ID=B.CATID AND A.NAME='Keyboard' AND B.NAME='Logitech' AND NOT EXISTS (SELECT 1 FROM category A, product B, orders C WHERE A.ID=B.CATID AND B.ID=C.PRDID AND A.NAME='Keyboard' AND B.NAME='Logitech' AND C.CONTACT='0400100103');
INSERT INTO orders (PRDID, QUANTITY, CONTACT) SELECT B.ID, 1, '0400100104' FROM category A, product B WHERE A.ID=B.CATID AND A.NAME='Mouse' AND B.NAME='Logitech' AND NOT EXISTS (SELECT 1 FROM category A, product B, orders C WHERE A.ID=B.CATID AND B.ID=C.PRDID AND A.NAME='Mouse' AND B.NAME='Logitech' AND C.CONTACT='0400100104');
INSERT INTO orders (PRDID, QUANTITY, CONTACT) SELECT B.ID, 2, '0400100105' FROM category A, product B WHERE A.ID=B.CATID AND A.NAME='Mouse' AND B.NAME='HP' AND NOT EXISTS (SELECT 1 FROM category A, product B, orders C WHERE A.ID=B.CATID AND B.ID=C.PRDID AND A.NAME='Mouse' AND B.NAME='HP' AND C.CONTACT='0400100105');
INSERT INTO orders (PRDID, QUANTITY, CONTACT) SELECT B.ID, 1, '0499887116' FROM category A, product B WHERE A.ID=B.CATID AND A.NAME='Mouse' AND B.NAME='HP' AND NOT EXISTS (SELECT 1 FROM category A, product B, orders C WHERE A.ID=B.CATID AND B.ID=C.PRDID AND A.NAME='Mouse' AND B.NAME='HP' AND C.CONTACT='0499887116');
